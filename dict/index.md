...
| :--- | :--- | :--- |
| [CMakeLists.txt](./CMakeLists.txt) | Build | CMake script that downloads SKK-JISYO.L and builds the `migemo-dict` and static `migemo-dict.sdict` files for the utf-8, euc-jp, and cp932 encodings. |
